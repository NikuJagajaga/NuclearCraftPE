...
Callback.addCallback("PreLoaded", function () {
    var addFuelRecipes = function (symbol, fertile) {
        ...
        fissiles.forEach(function (fissile) {
            ...
            Recipes2.addShapeless(NCID["LE" + symbol + fissile], [NCID[symbol + fissile], { id: NCID[symbol + fertile], count: 8 }]);
            Recipes2.addShapeless(NCID["LE" + symbol + fissile + "ox"], [NCID[symbol + fissile + "ox"], { id: NCID[symbol + fertile + "ox"], count: 8 }]);
            Recipes2.addShapeless(NCID["HE" + symbol + fissile], [{ id: NCID[symbol + fissile], count: 4 }, { id: NCID[symbol + fertile], count: 5 }]);
            Recipes2.addShapeless(NCID["HE" + symbol + fissile + "ox"], [{ id: NCID[symbol + fissile + "ox"], count: 4 }, { id: NCID[symbol + fertile + "ox"], count: 5 }]);
        });
    };
    Recipes2.addShapeless(NCID.TBU, [{ id: NCID.T232, count: 9 }]);
    Recipes2.addShapeless(NCID.TBUox, [{ id: NCID.T232ox, count: 9 }]);
    addFuelRecipes("U", 238, 233, 235);
    addFuelRecipes("N", 237, 236);
    addFuelRecipes("P", 242, 239, 241);
    Recipes2.addShapeless(NCID.MOX239, [NCID.P239ox, { id: NCID.U238ox, count: 8 }]);
    Recipes2.addShapeless(NCID.MOX241, [NCID.P241ox, { id: NCID.U238ox, count: 8 }]);
